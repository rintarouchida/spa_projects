    ...
    <div style="text-align:center;">
      <div class="message_form">
        ...
        <div v-for="(message_list, index) in message_lists" :key="index">
          <router-link style="color:black; text-decoration:none;" :to="`message_group/for_leader/${message_list.id}`">
...
export default {
  ...
  async created() {
    ...
    this.message_lists = await this.$axios.get('/api/message/index_for_leader').then(res => {
      return res.data;
    });
